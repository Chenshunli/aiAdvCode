...
if __name__ == '__main__':
    ...
    aug_opt = rand_augment_transform('rand-m9-mstd0.5-inc1', aa_params)
    img = default_loader('/dahuafs/userdata/46778/competition/AIsafety/code_base/easyrobust-main/RVT/images/new_cartoon_98.JPEG_test_org.png')
    aug_opt(img)
